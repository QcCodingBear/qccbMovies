<template>
  <div id="footer">
    <p id="up" @click="goUp">Remonter la page</p>
    <p>Copyright 2025</p>
    <p>420-FAG-LI</p>
    <p>TP3</p>
    <p>Thierry Matteucci</p>
    <img src="/src/assets/img/banniere.png" alt="banniere">
  </div>
</template>
...
<style scoped>
/*Source Rendre l'image de background transparente:
